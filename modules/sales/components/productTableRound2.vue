    ...
    <client-only>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody v-if="salesStore.ticket.ticketProducts.length > 0">
                    <template v-for="(data, key) in salesStore.ticket.ticketProducts" :key='key'>
                        <tr v-if="data.ticketProductItems.length == 1">
                            ...
                            <td>
                                <input type="number" class="form-control form-control-sm" @keypress="isNumberKey($event)" style="text-align: right;"
                                    @blur="priceAfterDiscountBlur($event)" v-model="data.ticketProductItems[0].priceFinal"
                                >
                            </td>
                            <td>
                        ...
                        <template v-else>
                            ...
                            <tr v-for="(data2, key2) in data.ticketProductItems.slice(1)" :key='key2'>
                                ...
                                <td>
                                    <input type="number" class="form-control form-control-sm" @keypress="isNumberKey($event)" style="text-align: right;"
                                        @blur="priceAfterDiscountBlur($event)" v-model="data2.priceFinal"
                                    >
                                </td>
                            </tr>
                        </template>
